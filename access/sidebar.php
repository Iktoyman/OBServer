...
<div id="sidebar-wrapper">
    <ul class="sidebar-nav">
        ...
        <li>
            <?php echo "<a href='../training/training_list.php?team=".$handled_teams[0]['team_id']."'>Training List</a>"; ?>
        </li>
        <?php
        ...
        <li>
            <?php echo "<a href='access_list.php?team=" . $handled_teams[0]['team_id'] . "'>Access List</a>"; ?>
        </li>
        <?php
        if (isset($_SESSION['ob_manager_id']) || isset($_SESSION['ob_trainer_id'])) {
        echo '<li>'
